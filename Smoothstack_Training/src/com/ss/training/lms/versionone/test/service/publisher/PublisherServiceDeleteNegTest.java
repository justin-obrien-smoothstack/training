package com.ss.training.lms.versionone.test.service.publisher;import static org.junit.Assert.assertEquals;
 ...
 *
 */
public class PublisherServiceDeleteNegTest {
	...
	public void test() { // passed
		...
		PublisherService.getInstance(books, authors, publishers, scanner).delete();
