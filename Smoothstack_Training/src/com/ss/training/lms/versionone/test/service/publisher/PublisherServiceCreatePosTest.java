 ...
 *
 */
public class PublisherServiceCreatePosTest {
	...
	public void test() { // passed
		...
		publisherTwo = publishers.get((long) 2);
		assertEquals("Publisher2", publisherTwo.getName());
		assertEquals("Address2", publisherTwo.getAddress());
	}
}
