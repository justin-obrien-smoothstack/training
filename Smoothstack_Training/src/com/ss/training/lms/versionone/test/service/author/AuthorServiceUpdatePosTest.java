package com.ss.training.lms.versionone.test.service.author;import static org.junit.Assert.assertEquals;
 ...
 *
 */
public class AuthorServiceUpdatePosTest {
	...
	public void test() { // passed
		stdIn.provideLines("1", "Name1");
		AuthorService.getInstance(books, authors, publishers, scanner).update();
		assertEquals(authors.get((long) 1).getName(), "Name1");
	}
}
